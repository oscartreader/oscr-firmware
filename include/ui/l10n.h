...
namespace OSCR
{
  namespace Lang
  {
    enum class DataSizeUnit : uint8_t
    {
      Base,
      Kilo,
      Mega,
    ...
    struct DataSize
    {
      ...
      // These are auto-generated by `updateDataSize(DataSize)`
      uint32_t formatSize = 0; //!< Formatted size
      char const * formatUnit = nullptr; //!< Formatted unit
      char const * format = nullptr; //!< Template/format to use for display with `formatSize`
      DataSizeUnit unit = DataSizeUnit::Base;
    };
    ...
    extern char const * formatLabel(char const * label);
    extern char const * formatLabel(char const * label, char const * value);
    extern char const * formatLabel_P(char const * label, char const * value);

    extern char const * formatType(char const * label);
    extern char const * formatType(char const * label, char const * value);
    extern char const * formatType_P(char const * label, char const * value);
    extern char const * formatSize_P(char const * label, char const * value);

    // flash pointer + SRAM number
    template <typename T,
              OSCR::Util::enable_if_t<OSCR::Util::is_integer<T>::value, bool> Enable = true>
    extern char const * formatType(char const * label, T number);

    template <typename T,
              OSCR::Util::enable_if_t<OSCR::Util::is_integer<T>::value, bool> Enable = true>
    extern char const * formatLabel(char const * label, T number);

    template <typename T,
              OSCR::Util::enable_if_t<OSCR::Util::is_integer<T>::value, bool> Enable = true>
    extern char const * formatLabel(char const * label, T number, T total);

    extern char const * formatLabelSize(char const * label, uint32_t size, bool isBytes);
    ...
    extern void updateDataSize(DataSize & dataSize);
  ...
  namespace Strings
  {
    ...
    namespace Common
    {
      ...
      extern char const PROGMEM Block[];
      ...
      extern char const PROGMEM Mono[];
      extern char const PROGMEM Color[];
    ...
    namespace Templates
    {
      ...
      extern char const PROGMEM WordsPPPPP[];
      extern char const * const WordsPPPP;
      extern char const * const WordsPPP;
      extern char const * const WordsPP;

      extern char const PROGMEM TypeP[];
      extern char const PROGMEM SizeP[];

      extern char const PROGMEM SizeLabelFormat[];

      extern char const PROGMEM Label[];
      extern char const PROGMEM LabelP[];
      extern char const PROGMEM LabelPValue[];
      extern char const PROGMEM LabelPValueP[];
      extern char const PROGMEM LabelPValueU32[];
      extern char const PROGMEM LabelPValueD32[];
      extern char const PROGMEM LabelPValuesU32[];
      extern char const PROGMEM LabelPValuesD32[];
